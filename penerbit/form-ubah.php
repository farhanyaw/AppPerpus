...
<div class="p-4 sm:ml-64">
    <div class="p-4 mt-14">
        <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-black">Ubah Data Penerbit</h2>
        <form action="proses-ubah.php" method="post">
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                <div class="w-full">
                    ...
                    <input type="text" value="<?= $penerbit->NamaPenerbit ?>" name="NamaPenerbit" id="NamaPenerbit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 white:bg-gray-700 white white:border-gray-600 white:placeholder-gray-400 dark:text-black white:focus:ring-primary-500 white:focus:border-primary-500" placeholder="Masukkan NamaPenerbit Lengkap" required="">
                </div>
                <div class="sm:col-span-2">
                    <label for="alamat" class="block mb-2 text-sm font-medium text-gray-900 dark:text-xl">Alamat</label>
                    <textarea name="alamat" id="alamat" rows="8" class="block p-2.5 w-full text-sm text-black bg-gray-50 rounded-lg border border-gray-200 focus:ring-primary-500 focus:border-primary-500 white:bg-gray-700 dark:border-gray-300 dark:placeholder-gray-400 dark:text-black white:focus:ring-primary-500 white:focus:border-primary-500" placeholder="Masukkan Alamat"><?= $penerbit->Alamat ?></textarea> 
                <div>
                    <label for="notelp" class="sm:col-span-2">Nomor Telepon</label>
                    <input type="number" value="<?= $penerbit->NoTelp ?>" name="notelp" id="notelp" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 white:bg-gray-700 dark:border-gray-300 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="12" required="">
                    <div class="sm:col-span-2">
